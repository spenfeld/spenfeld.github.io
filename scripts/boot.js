// Plays the "boot sequence" overlay once per browser session (tracked
// via window.name, which survives navigation but not a fresh tab/window),
// then cycles through a few status lines before fading out.
(function () {
  ...
  // Final message is page-specific; everything else is generic.
  const pageMessages = {
